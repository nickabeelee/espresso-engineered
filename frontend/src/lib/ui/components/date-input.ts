...
const dateInput = {
  ...
  calendar: {
    ...
    titleWeight: 600,
    titleColor: colorCss.text.ink.primary,
    weekdaySize: fontSizes.xs,
    weekdayColor: colorCss.text.ink.muted,
    weekdayMargin: "0.35rem",
    gridGap: "0.25rem",
    navSize: "32px",
    navPadding: "0.2rem",
    navRadius: radius.sm,
    daySize: "2.2rem",
    dayRadius: radius.sm,
    dayFontSize: fontSizes.sm,
    dayColor: colorCss.text.ink.primary,
    dayOutsideColor: colorCss.text.ink.placeholder,
    dayDisabledColor: colorCss.text.ink.placeholder,
    dayHoverBackground: colorCss.bg.surface.paper.secondary,
    daySelectedBackground: colorCss.accent.primary,
    daySelectedColor: colorCss.text.ink.inverted,
    dayTodayBorder: colorCss.accent.primaryDark,
  },
  action: {
    fontFamily: fontFamilies.ui,
    fontSize: fontSizes.sm,
